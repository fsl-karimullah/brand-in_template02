...
const Cta = () => {
  return (
    <section style={{ backgroundImage: `url(${Img})` }} className="flex w-full flex-col gap-4 bg-cover bg-top px-4 py-20 md:flex-row md:items-center md:justify-center lg:gap-8 lg:py-40" id="contact">
