...
import "swiper/css";
import Img1 from "../../assets/car/car1.webp";
import Img2 from "../../assets/car/car2.webp";
import Img3 from "../../assets/car/car3.webp";
    ...
    <>
      ...
      >
        <SwiperSlide className="p-2">
          <div className="h-40 rounded-xl p-1 shadow-xl lg:h-60">
